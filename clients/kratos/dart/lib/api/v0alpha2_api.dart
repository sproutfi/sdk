...
class V0alpha2Api {
  ...
  Future<Response<Identity>> adminCreateIdentity({
    ...
    _bodyData =
        _serializers.serialize(adminCreateIdentityBody, specifiedType: _type);
  ...
  Future<Response<SelfServiceRecoveryLink>> adminCreateSelfServiceRecoveryLink({
    ...
    _bodyData = _serializers.serialize(adminCreateSelfServiceRecoveryLinkBody,
        specifiedType: _type);
  ...
  Future<Response<void>> adminDeleteIdentity(
    ...
    final _response = await _dio.request<dynamic>(
      r'/identities/{id}'.replaceAll('{' r'id' '}', id.toString()),
      data: _bodyData,
      options: _request,
      cancelToken: cancelToken,
      onSendProgress: onSendProgress,
  ...
  Future<Response<void>> adminDeleteIdentitySessions(
    ...
    final _response = await _dio.request<dynamic>(
      r'/identities/{id}/sessions'.replaceAll('{' r'id' '}', id.toString()),
      data: _bodyData,
      options: _request,
      cancelToken: cancelToken,
      onSendProgress: onSendProgress,
  ...
  Future<Response<Identity>> adminUpdateIdentity(
    ...
    _bodyData =
        _serializers.serialize(adminUpdateIdentityBody, specifiedType: _type);
  ...
  Future<Response<SelfServiceLogoutUrl>>
  ...
  Future<Response<JsonObject>> getJsonSchema(
    ...
    final _response = await _dio.request<dynamic>(
      r'/schemas/{id}'.replaceAll('{' r'id' '}', id.toString()),
      data: _bodyData,
      options: _request,
      cancelToken: cancelToken,
      onSendProgress: onSendProgress,
  ...
  Future<Response<SelfServiceRegistrationFlow>> getSelfServiceRegistrationFlow(
    ...
    final _response = await _dio.request<dynamic>(
      r'/self-service/registration/flows',
      queryParameters: <String, dynamic>{
        r'id': id,
      },
      data: _bodyData,
  ...
  Future<Response<SelfServiceVerificationFlow>> getSelfServiceVerificationFlow(
    ...
    final _response = await _dio.request<dynamic>(
      r'/self-service/verification/flows',
      queryParameters: <String, dynamic>{
        r'id': id,
      },
      data: _bodyData,
  ...
  Future<Response<SelfServiceLoginFlow>>
  ...
  Future<Response<SelfServiceRecoveryFlow>>
    ...
    final _response = await _dio.request<dynamic>(
      r'/self-service/recovery/browser',
      queryParameters: <String, dynamic>{
        if (returnTo != null) r'return_to': returnTo,
      },
      data: _bodyData,
  ...
  Future<Response<SelfServiceRegistrationFlow>>
    ...
    final _response = await _dio.request<dynamic>(
      r'/self-service/registration/browser',
      queryParameters: <String, dynamic>{
        if (returnTo != null) r'return_to': returnTo,
      },
      data: _bodyData,
  ...
  Future<Response<SelfServiceRegistrationFlow>>
    ...
    final _response = await _dio.request<dynamic>(
      r'/self-service/registration/api',
      data: _bodyData,
      options: _request,
      cancelToken: cancelToken,
      onSendProgress: onSendProgress,
  ...
  Future<Response<SelfServiceSettingsFlow>>
    ...
    final _response = await _dio.request<dynamic>(
      r'/self-service/settings/browser',
      queryParameters: <String, dynamic>{
        if (returnTo != null) r'return_to': returnTo,
      },
      data: _bodyData,
  ...
  Future<Response<SelfServiceVerificationFlow>>
    ...
    final _response = await _dio.request<dynamic>(
      r'/self-service/verification/browser',
      queryParameters: <String, dynamic>{
        if (returnTo != null) r'return_to': returnTo,
      },
      data: _bodyData,
  ...
  Future<Response<SelfServiceVerificationFlow>>
    ...
    final _response = await _dio.request<dynamic>(
      r'/self-service/verification/api',
      data: _bodyData,
      options: _request,
      cancelToken: cancelToken,
      onSendProgress: onSendProgress,
  ...
  Future<Response<SuccessfulSelfServiceLoginWithoutBrowser>>
    ...
    _bodyData = _serializers.serialize(submitSelfServiceLoginFlowBody,
        specifiedType: _type);

    final _response = await _dio.request<dynamic>(
      r'/self-service/login',
      queryParameters: <String, dynamic>{
        r'flow': flow,
      },
      data: _bodyData,
  ...
  Future<Response<SelfServiceRecoveryFlow>> submitSelfServiceRecoveryFlow(
    ...
    _bodyData = _serializers.serialize(submitSelfServiceRecoveryFlowBody,
        specifiedType: _type);

    final _response = await _dio.request<dynamic>(
      r'/self-service/recovery',
      queryParameters: <String, dynamic>{
        r'flow': flow,
        if (token != null) r'token': token,
      },
  ...
  Future<Response<SuccessfulSelfServiceRegistrationWithoutBrowser>>
    ...
    _bodyData = _serializers.serialize(submitSelfServiceRegistrationFlowBody,
        specifiedType: _type);

    final _response = await _dio.request<dynamic>(
      r'/self-service/registration',
      queryParameters: <String, dynamic>{
        r'flow': flow,
      },
      data: _bodyData,
    ...
    const _responseType =
        FullType(SuccessfulSelfServiceRegistrationWithoutBrowser);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
  ...
  Future<Response<SelfServiceSettingsFlow>> submitSelfServiceSettingsFlow(
    ...
    _bodyData = _serializers.serialize(submitSelfServiceSettingsFlowBody,
        specifiedType: _type);

    final _response = await _dio.request<dynamic>(
      r'/self-service/settings',
      queryParameters: <String, dynamic>{
        r'flow': flow,
      },
      data: _bodyData,
  ...
  Future<Response<SelfServiceVerificationFlow>>
    ...
    _bodyData = _serializers.serialize(submitSelfServiceVerificationFlowBody,
        specifiedType: _type);

    final _response = await _dio.request<dynamic>(
      r'/self-service/verification',
      queryParameters: <String, dynamic>{
        r'flow': flow,
        if (token != null) r'token': token,
      },
