...
abstract class SessionDevice
    implements Built<SessionDevice, SessionDeviceBuilder> {
  ...
  factory SessionDevice([void updates(SessionDeviceBuilder b)]) =
      _$SessionDevice;

  @BuiltValueSerializer(custom: true)
  static Serializer<SessionDevice> get serializer =>
      _$SessionDeviceSerializer();
}
