...
abstract class SelfServiceVerificationFlow
    implements
        Built<SelfServiceVerificationFlow, SelfServiceVerificationFlowBuilder> {
  ...
  factory SelfServiceVerificationFlow(
          [void updates(SelfServiceVerificationFlowBuilder b)]) =
      _$SelfServiceVerificationFlow;

  @BuiltValueSerializer(custom: true)
  static Serializer<SelfServiceVerificationFlow> get serializer =>
      _$SelfServiceVerificationFlowSerializer();
}

class _$SelfServiceVerificationFlowSerializer
    implements StructuredSerializer<SelfServiceVerificationFlow> {
  @override
  ...
  Iterable<Object> serialize(
      Serializers serializers, SelfServiceVerificationFlow object,
      ...
      switch (key) {
        ...
        case r'state':
          result.state = serializers.deserialize(value,
                  specifiedType:
                      const FullType(SelfServiceVerificationFlowState))
