...
abstract class SubmitSelfServiceLoginFlowWithPasswordMethodBody
    implements
        Built<SubmitSelfServiceLoginFlowWithPasswordMethodBody,
  ...
  static void _initializeBuilder(
          SubmitSelfServiceLoginFlowWithPasswordMethodBodyBuilder b) =>
      b;

  factory SubmitSelfServiceLoginFlowWithPasswordMethodBody(
          [void updates(
              SubmitSelfServiceLoginFlowWithPasswordMethodBodyBuilder b)]) =
      _$SubmitSelfServiceLoginFlowWithPasswordMethodBody;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubmitSelfServiceLoginFlowWithPasswordMethodBody>
      get serializer =>
          _$SubmitSelfServiceLoginFlowWithPasswordMethodBodySerializer();
}

class _$SubmitSelfServiceLoginFlowWithPasswordMethodBodySerializer
    implements
        StructuredSerializer<SubmitSelfServiceLoginFlowWithPasswordMethodBody> {
  @override
