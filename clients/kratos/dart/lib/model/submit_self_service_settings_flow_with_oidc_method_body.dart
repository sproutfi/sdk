...
abstract class SubmitSelfServiceSettingsFlowWithOidcMethodBody
    implements
        Built<SubmitSelfServiceSettingsFlowWithOidcMethodBody,
  ...
  static void _initializeBuilder(
          SubmitSelfServiceSettingsFlowWithOidcMethodBodyBuilder b) =>
      b;

  factory SubmitSelfServiceSettingsFlowWithOidcMethodBody(
          [void updates(
              SubmitSelfServiceSettingsFlowWithOidcMethodBodyBuilder b)]) =
      _$SubmitSelfServiceSettingsFlowWithOidcMethodBody;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubmitSelfServiceSettingsFlowWithOidcMethodBody>
      get serializer =>
          _$SubmitSelfServiceSettingsFlowWithOidcMethodBodySerializer();
}

class _$SubmitSelfServiceSettingsFlowWithOidcMethodBodySerializer
    implements
        StructuredSerializer<SubmitSelfServiceSettingsFlowWithOidcMethodBody> {
  @override
