...
class _$Identity extends Identity {
  ...
  final String id;
  @override
  final BuiltList<RecoveryAddress>? recoveryAddresses;
  @override
  ...
  _$Identity._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(id, 'Identity', 'id');
    BuiltValueNullFieldError.checkNotNull(schemaId, 'Identity', 'schemaId');
    BuiltValueNullFieldError.checkNotNull(schemaUrl, 'Identity', 'schemaUrl');
  }
...
class IdentityBuilder implements Builder<Identity, IdentityBuilder> {
  ...
  ListBuilder<RecoveryAddress>? _recoveryAddresses;
  ListBuilder<RecoveryAddress> get recoveryAddresses =>
      _$this._recoveryAddresses ??= new ListBuilder<RecoveryAddress>();
  set recoveryAddresses(ListBuilder<RecoveryAddress>? recoveryAddresses) =>
  ...
  IdentityBuilder() {
    Identity._initializeBuilder(this);
  }
