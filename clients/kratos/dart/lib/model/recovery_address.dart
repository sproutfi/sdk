...
abstract class RecoveryAddress
    implements Built<RecoveryAddress, RecoveryAddressBuilder> {
  ...
  factory RecoveryAddress([void updates(RecoveryAddressBuilder b)]) =
      _$RecoveryAddress;

  @BuiltValueSerializer(custom: true)
  static Serializer<RecoveryAddress> get serializer =>
      _$RecoveryAddressSerializer();
}

class _$RecoveryAddressSerializer
    implements StructuredSerializer<RecoveryAddress> {
  @override
