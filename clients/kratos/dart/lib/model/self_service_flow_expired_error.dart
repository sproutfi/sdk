...
abstract class SelfServiceFlowExpiredError
    implements
        Built<SelfServiceFlowExpiredError, SelfServiceFlowExpiredErrorBuilder> {
  /// The status code
  ...
  factory SelfServiceFlowExpiredError(
          [void updates(SelfServiceFlowExpiredErrorBuilder b)]) =
      _$SelfServiceFlowExpiredError;

  @BuiltValueSerializer(custom: true)
  static Serializer<SelfServiceFlowExpiredError> get serializer =>
      _$SelfServiceFlowExpiredErrorSerializer();
}

class _$SelfServiceFlowExpiredErrorSerializer
    implements StructuredSerializer<SelfServiceFlowExpiredError> {
  @override
  ...
  Iterable<Object> serialize(
      Serializers serializers, SelfServiceFlowExpiredError object,
