...
abstract class SessionAuthenticationMethod
    implements
        Built<SessionAuthenticationMethod, SessionAuthenticationMethodBuilder> {
  ...
  factory SessionAuthenticationMethod(
          [void updates(SessionAuthenticationMethodBuilder b)]) =
      _$SessionAuthenticationMethod;

  @BuiltValueSerializer(custom: true)
  static Serializer<SessionAuthenticationMethod> get serializer =>
      _$SessionAuthenticationMethodSerializer();
}

class _$SessionAuthenticationMethodSerializer
    implements StructuredSerializer<SessionAuthenticationMethod> {
  @override
  ...
  Iterable<Object> serialize(
      Serializers serializers, SessionAuthenticationMethod object,
    ...
    if (object.method != null) {
      result
        ...
        ..add(serializers.serialize(object.method,
            specifiedType:
                const FullType(SessionAuthenticationMethodMethodEnum))!);
    }
    return result;
  }
