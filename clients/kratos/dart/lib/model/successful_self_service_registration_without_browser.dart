...
abstract class SuccessfulSelfServiceRegistrationWithoutBrowser
    implements
        Built<SuccessfulSelfServiceRegistrationWithoutBrowser,
  ...
  static void _initializeBuilder(
          SuccessfulSelfServiceRegistrationWithoutBrowserBuilder b) =>
      b;

  factory SuccessfulSelfServiceRegistrationWithoutBrowser(
          [void updates(
              SuccessfulSelfServiceRegistrationWithoutBrowserBuilder b)]) =
      _$SuccessfulSelfServiceRegistrationWithoutBrowser;

  @BuiltValueSerializer(custom: true)
  static Serializer<SuccessfulSelfServiceRegistrationWithoutBrowser>
      get serializer =>
          _$SuccessfulSelfServiceRegistrationWithoutBrowserSerializer();
}

class _$SuccessfulSelfServiceRegistrationWithoutBrowserSerializer
    implements
        StructuredSerializer<SuccessfulSelfServiceRegistrationWithoutBrowser> {
  @override
