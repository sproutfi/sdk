...
abstract class SubmitSelfServiceLoginFlowWithOidcMethodBody
    implements
        Built<SubmitSelfServiceLoginFlowWithOidcMethodBody,
  ...
  static void _initializeBuilder(
          SubmitSelfServiceLoginFlowWithOidcMethodBodyBuilder b) =>
      b;

  factory SubmitSelfServiceLoginFlowWithOidcMethodBody(
          [void updates(
              SubmitSelfServiceLoginFlowWithOidcMethodBodyBuilder b)]) =
      _$SubmitSelfServiceLoginFlowWithOidcMethodBody;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubmitSelfServiceLoginFlowWithOidcMethodBody>
      get serializer =>
          _$SubmitSelfServiceLoginFlowWithOidcMethodBodySerializer();
}

class _$SubmitSelfServiceLoginFlowWithOidcMethodBodySerializer
    implements
        StructuredSerializer<SubmitSelfServiceLoginFlowWithOidcMethodBody> {
  @override
