...
abstract class SubmitSelfServiceLogoutFlowWithoutBrowserBody
    implements
        Built<SubmitSelfServiceLogoutFlowWithoutBrowserBody,
  ...
  static void _initializeBuilder(
          SubmitSelfServiceLogoutFlowWithoutBrowserBodyBuilder b) =>
      b;

  factory SubmitSelfServiceLogoutFlowWithoutBrowserBody(
          [void updates(
              SubmitSelfServiceLogoutFlowWithoutBrowserBodyBuilder b)]) =
      _$SubmitSelfServiceLogoutFlowWithoutBrowserBody;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubmitSelfServiceLogoutFlowWithoutBrowserBody>
      get serializer =>
          _$SubmitSelfServiceLogoutFlowWithoutBrowserBodySerializer();
}

class _$SubmitSelfServiceLogoutFlowWithoutBrowserBodySerializer
    implements
        StructuredSerializer<SubmitSelfServiceLogoutFlowWithoutBrowserBody> {
  @override
