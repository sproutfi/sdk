...
abstract class SubmitSelfServiceLoginFlowWithTotpMethodBody
    implements
        Built<SubmitSelfServiceLoginFlowWithTotpMethodBody,
  ...
  static void _initializeBuilder(
          SubmitSelfServiceLoginFlowWithTotpMethodBodyBuilder b) =>
      b;

  factory SubmitSelfServiceLoginFlowWithTotpMethodBody(
          [void updates(
              SubmitSelfServiceLoginFlowWithTotpMethodBodyBuilder b)]) =
      _$SubmitSelfServiceLoginFlowWithTotpMethodBody;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubmitSelfServiceLoginFlowWithTotpMethodBody>
      get serializer =>
          _$SubmitSelfServiceLoginFlowWithTotpMethodBodySerializer();
}

class _$SubmitSelfServiceLoginFlowWithTotpMethodBodySerializer
    implements
        StructuredSerializer<SubmitSelfServiceLoginFlowWithTotpMethodBody> {
  @override
