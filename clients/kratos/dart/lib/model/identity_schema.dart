...
abstract class IdentitySchema
    implements Built<IdentitySchema, IdentitySchemaBuilder> {
  ...
  factory IdentitySchema([void updates(IdentitySchemaBuilder b)]) =
      _$IdentitySchema;

  @BuiltValueSerializer(custom: true)
  static Serializer<IdentitySchema> get serializer =>
      _$IdentitySchemaSerializer();
}

class _$IdentitySchemaSerializer
    implements StructuredSerializer<IdentitySchema> {
  @override
