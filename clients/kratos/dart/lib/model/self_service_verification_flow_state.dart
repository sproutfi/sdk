...
class SelfServiceVerificationFlowState extends EnumClass {
  ...
  static const SelfServiceVerificationFlowState passedChallenge =
      _$passedChallenge;

  static Serializer<SelfServiceVerificationFlowState> get serializer =>
  ...
  static SelfServiceVerificationFlowState valueOf(String name) =>
      _$valueOf(name);
}
...
abstract class SelfServiceVerificationFlowStateMixin = Object
    with _$SelfServiceVerificationFlowStateMixin;
