...
abstract class SubmitSelfServiceLoginFlowWithWebAuthnMethodBody
    implements
        Built<SubmitSelfServiceLoginFlowWithWebAuthnMethodBody,
  ...
  static void _initializeBuilder(
          SubmitSelfServiceLoginFlowWithWebAuthnMethodBodyBuilder b) =>
      b;

  factory SubmitSelfServiceLoginFlowWithWebAuthnMethodBody(
          [void updates(
              SubmitSelfServiceLoginFlowWithWebAuthnMethodBodyBuilder b)]) =
      _$SubmitSelfServiceLoginFlowWithWebAuthnMethodBody;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubmitSelfServiceLoginFlowWithWebAuthnMethodBody>
      get serializer =>
          _$SubmitSelfServiceLoginFlowWithWebAuthnMethodBodySerializer();
}

class _$SubmitSelfServiceLoginFlowWithWebAuthnMethodBodySerializer
    implements
        StructuredSerializer<SubmitSelfServiceLoginFlowWithWebAuthnMethodBody> {
  @override
