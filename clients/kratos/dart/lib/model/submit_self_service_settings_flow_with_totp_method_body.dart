...
abstract class SubmitSelfServiceSettingsFlowWithTotpMethodBody
    implements
        Built<SubmitSelfServiceSettingsFlowWithTotpMethodBody,
  ...
  static void _initializeBuilder(
          SubmitSelfServiceSettingsFlowWithTotpMethodBodyBuilder b) =>
      b;

  factory SubmitSelfServiceSettingsFlowWithTotpMethodBody(
          [void updates(
              SubmitSelfServiceSettingsFlowWithTotpMethodBodyBuilder b)]) =
      _$SubmitSelfServiceSettingsFlowWithTotpMethodBody;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubmitSelfServiceSettingsFlowWithTotpMethodBody>
      get serializer =>
          _$SubmitSelfServiceSettingsFlowWithTotpMethodBodySerializer();
}

class _$SubmitSelfServiceSettingsFlowWithTotpMethodBodySerializer
    implements
        StructuredSerializer<SubmitSelfServiceSettingsFlowWithTotpMethodBody> {
  @override
