      ...
      result
        ...
        ..add(serializers.serialize(object.credentials,
            specifiedType: const FullType(
                BuiltMap, [FullType(String), FullType(IdentityCredentials)]))!);
    }
    result
      ..add(r'id')
    ...
    if (object.recoveryAddresses != null) {
      result
        ...
        ..add(serializers.serialize(object.recoveryAddresses,
            specifiedType:
                const FullType(BuiltList, [FullType(RecoveryAddress)]))!);
    }
    result
      ..add(r'schema_id')
    ...
    if (object.verifiableAddresses != null) {
      result
        ...
        ..add(serializers.serialize(object.verifiableAddresses,
            specifiedType: const FullType(
                BuiltList, [FullType(VerifiableIdentityAddress)]))!);
    }
    return result;
  }
